...
----
*영상에 페이드 아웃/팝 등등 효과를 적용하는 기능(추가 예정)*

*구간을 지정하면 구간에 따라 다른 소스를 넣어 풍부한 영상을 만드는 기능(추가 예정)*

*미디의 각 레이어 마다 다른 소스를 넣을 수 있는 기능(추가 예정)*
...
> [!TIP]
> 미디를 사이트에 오디오를 넣을 때는 보컬, 드럼 소리를 제거하고 오디오를 넣으면 결과가 더 좋아집니다.
